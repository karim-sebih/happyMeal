...
function openModal(recipe) {
    ...
    recipe.ingredients.forEach(ing => {
        ...
        // Extraction correcte du nom de l'ingrédient
        let ingredientName;
        if (typeof ing === "object") {
            ingredientName = ing.nom; // On prend uniquement le nom
        } else {
            ingredientName = ing;
        }
        ...
        li.appendChild(checkbox);
        li.appendChild(document.createTextNode(" " + ingredientName)); // Affichage correct
        ingredientsList.appendChild(li);
    });
