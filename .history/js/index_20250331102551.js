...
function checkStoredIngredients() {
    const storedIngredients = JSON.parse(localStorage.getItem("selectedIngredients")) || [];
    ...
    checkboxes.forEach(checkbox => {
        ...
        if (label) {
            const ingredientName = label.textContent.split(' - ')[1]; // On récupère juste le nom de l'ingrédient sans la quantité
            // Si l'ingrédient est déjà dans le localStorage, coche la checkbox
